...
export default function DarkModeBtn({className,toggleOpen}:{className?:string,toggleOpen:Cycle}) {
    ...
    return   <motion.li variants={variants} className={cls(className ?? "", "flex m-auto p-2.5 cursor-pointer group hover:bg-gray-400 hover:rounded-xl dark:hover:bg-blue-300 hover:shadow-md hover:shadow-slate-300 ")}>
        <div
            onClick={() => {
